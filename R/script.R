...
list_of_files <- list.files(path = "C:/Users/planteb/Desktop/Projet R/EMA_Open_dataset/data/raw/UT1000_ema/UT1000_fall2018",
                            recursive = TRUE,
...
list_of_files <- list.files(path = "C:/Users/planteb/Desktop/Projet R/EMA_Open_dataset/data/raw/UT1000_ema/UT1000_spring2019",
                            recursive = TRUE,
                            pattern = "momentary_emas.csv$",
                            full.names = TRUE)
...
df_participant <- read_delim("C:/Users/planteb/Desktop/Projet R/EMA_Open_dataset/data/raw/participant.txt", delim = ",")
